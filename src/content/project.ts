...
const content = {
  nl: {
    meta: {
      ...
      description:
        "1-op-1 en kleinschalige zwemlessen voor volwassenen in Zeeland. Engelssprekende coach met focus op zelfvertrouwen, waterveiligheid en techniek.",
    },
    header: {
      menu_label: "Menu",
      subtitle: "Zwemcoaching voor volwassenen. Steunend, geduldig en gericht op vooruitgang.",
    ...
    hero: {
      ...
      subtitle: "Persoonlijke coaching voor volwassenen. Steunend, geduldig en zonder druk.",
      cta_main: "Aanmelden",
    ...
    homeFacts: {
      ...
      format: "Kleine groepen • In jouw tempo • 45 min per les",
    },
    firstLesson: {
    ...
    about: {
      ...
      story: `Mijn naam is Nathalie en ik werk met volwassenen die zich veilig en zelfverzekerd willen voelen in het water.

Veel van mijn zwemmers komen bij me met een gevoel van nervositeit, schaamte of frustratie, omdat ze denken dat ze dit jaren geleden al hadden moeten leren, of omdat ze een waterervaring uit hun jeugd meedragen die nog steeds in hun lichaam zit. Met geduld en tijd leren ze het water te vertrouwen, hun ademhaling te beheersen en met meer gemak te bewegen, stap voor stap, met het juiste niveau van uitdaging.

Mijn motivatie is een missie geworden.

Ik geloof oprecht dat er niet zoiets bestaat als “te laat”, alleen je eigen timing.

Ik bied 1-op-1 en kleine groepslessen voor volwassenen: beginners, mensen met watervrees, mensen die na jaren weer beginnen, en zwemmers die hun techniek willen verbeteren of een nieuwe slag willen leren.

Mijn aanpak is steunend, persoonlijk en zonder druk. We gaan stap voor stap, altijd in jouw tempo. Geen geschreeuw, geen dwang, geen oordeel, alleen geduld, duidelijkheid en vertrouwen.

Humor is een hulpmiddel, gebouwd op een basis van veiligheid.
...
Zwemmen gaat niet om prestaties. Het gaat erom je veilig, ontspannen en vrij te voelen in het water. En ja, zelfs volwassenen kunnen ervan leren genieten.`,
    ...
    contact: {
      ...
      subtitle:
        "Heeft u een vraag of wilt u zich aanmelden? Stuur gerust een bericht. Geen druk om direct te boeken.",
      form_name: "Volledige naam",
      form_name_placeholder: "Uw naam",
      form_email: "E-mail",
      form_email_placeholder: "uw@email.com",
      form_message: "Uw bericht",
      form_message_placeholder: "Vertel kort waar u hulp bij zoekt...",
    ...
    info: {
      ...
      subtitle: "Prijzen, locatie en planning, helder.",
      trust_45: "45 minuten per les",
      trust_safe: "Steunend, discreet, zonder oordeel",
      trust_location: "Zeeland (exacte locatie na aanmelding)",
      pricing_title: "Prijzen",
      pricing_desc: "Simpel en helder.",
      pricing_note:
        "Prijzen zijn per persoon. Zwembadtoegang en btw kunnen per locatie verschillen. We bevestigen dit bij het plannen.",
      ...
      location_desc: "Zeeland, discreet en comfortabel.",
      location_body:
        "Lessen vinden plaats in een rustige zwemlocatie in Zeeland. De exacte details delen we na aanmelding om privacy te waarborgen en de setting prettig te houden.",
      ...
      price_private: "1-op-1 les (45 min)",
    ...
    for_you: {
      ...
      who_list: [
        ...
        "Iedereen die wil leren in een discrete, niet-oordelende omgeving.",
      ...
      reassurances: [
        {
          ...
          description:
            "Onze lessen beginnen helemaal bij het begin. We gaan nergens van uit en leren alles.",
        },
        {
          title: "Nerveus zijn is oké.",
          description:
            "Veel volwassenen voelen hetzelfde. Ons eerste doel is om u te helpen zich veilig en comfortabel te voelen.",
        },
        {
          title: "Taal is geen barrière.",
          description:
            "De lessen zijn in eenvoudig Engels. De nadruk ligt op duidelijke, rustige instructie.",
        },
        {
          title: "Er is geen 'juiste' tijdlijn.",
          description:
            "U zult vooruitgang boeken op uw eigen tempo. Er is geen druk om te presteren.",
        },
      ],
...
Swimming is not about performance. It’s about feeling safe, relaxed, and free in the water. And yes, even adults can learn to enjoy it.`,
  ...
  fr: {
    meta: {
      ...
      description:
        "Cours 1:1 et en petits groupes pour adultes en Zélande. Coach anglophone, axé sur la confiance, la sécurité et l’amélioration technique.",
    },
    header: {
      menu_label: "Menu",
      subtitle: "Coaching natation adultes. Bienveillant, patient, et axé sur le progrès.",
    ...
    hero: {
      ...
      subtitle: "Coaching personnel pour adultes. Bienveillant, patient et sans pression.",
      cta_main: "S’inscrire",
    ...
    about: {
      ...
      story: `Je m’appelle Nathalie et j’accompagne des adultes qui veulent se sentir en sécurité et en confiance dans l’eau.

Beaucoup de nageurs arrivent nerveux, gênés ou frustrés parce qu’ils pensent qu’ils auraient dû apprendre il y a longtemps, ou parce qu’une expérience de l’enfance reste présente. Avec patience et du temps, ils apprennent à faire confiance à l’eau, à contrôler la respiration et à bouger avec plus d’aisance, pas à pas, avec le bon niveau de défi.

Ma motivation est devenue une mission.
...
Mon approche est bienveillante, personnelle et sans pression. Nous avançons pas à pas, à votre rythme. Pas de cris, pas de contrainte, pas de jugement, seulement patience, clarté et confiance.

L’humour est un outil, fondé sur la sécurité.
...
La natation n’est pas une question de performance. Il s’agit de se sentir en sécurité, détendu et libre dans l’eau. Et oui, même les adultes peuvent apprendre à l’apprécier.`,
    ...
    info: {
      ...
      subtitle: "Tarifs, lieu et planning, clairement.",
      trust_45: "45 minutes par cours",
      trust_safe: "Bienveillant, discret, sans jugement",
      trust_location: "Zélande (lieu exact après inscription)",
      pricing_title: "Tarifs",
      pricing_desc: "Simple et transparent.",
      pricing_note:
        "Tarifs par personne. L’accès piscine et la TVA peuvent varier selon le lieu. Confirmé lors de la planification.",
      ...
      table_price: "Prix",
      location_title: "Lieu",
      location_desc: "Zélande, discret et confortable.",
      location_body:
        "Les cours ont lieu dans un établissement calme en Zélande. Les détails exacts sont communiqués après inscription pour préserver la confidentialité et garder une bonne ambiance.",
      location_cta: "Demander l’option la plus proche",
      scheduling_title: "Planning",
      scheduling_desc: "En semaine, créneaux flexibles.",
      scheduling_body:
        "Les cours sont généralement possibles en semaine, le matin ou le soir. Envoyez vos disponibilités et nous confirmons ce qui est possible.",
      scheduling_cta: "Vérifier la disponibilité",
      price_tryout: "Leçon d’essai (45 min, une fois)",
      price_private: "Cours 1:1 (45 min)",
    ...
    for_you: {
      ...
      subtitle:
        "Ces leçons sont conçues pour les adultes de tous horizons qui veulent trouver confort et sécurité dans l'eau. Voyez si cela vous parle.",
      ...
      who_list: [
        ...
        "Toute personne qui veut apprendre dans un cadre discret et sans jugement.",
      ...
      reassurances: [
        {
          ...
          description:
            "Nos leçons partent de zéro. Nous ne supposons rien et enseignons tout.",
        },
        {
          title: "C'est normal d'être nerveux.",
          description:
            "Beaucoup d'adultes ressentent la même chose. Notre premier objectif est de vous aider à vous sentir en sécurité et à l'aise.",
        },
        {
          title: "La langue n'est pas une barrière.",
          description:
            "Les leçons sont en anglais simple. L'accent est mis sur des instructions claires et régulières.",
        },
        {
          title: "Il n'y a pas de 'bon' calendrier.",
          description:
            "Vous progresserez à votre propre rythme. Il n'y a aucune pression de performance.",
        },
      ],
      cta_title: "Votre parcours commence par une simple conversation.",
      cta_subtitle:
        "Si vous avez des questions, ou si vous voulez simplement savoir si c'est pour vous, n'hésitez pas à nous contacter. Il n'y a aucun engagement.",
  ...
  es: {
    ...
    header: {
      menu_label: "Menú",
      subtitle: "Coaching de natación para adultos. Cercano, paciente y enfocado en tu progreso.",
    ...
    hero: {
      ...
      subtitle: "Entrenamiento personal para adultos. Cercano, paciente y sin presiones.",
      cta_main: "Inscríbete",
    ...
    about: {
      ...
      story: `Me llamo Nathalie y trabajo con adultos que quieren sentirse seguros y con confianza en el agua.

Muchos nadadores llegan nerviosos, con vergüenza o frustrados porque piensan que deberían haber aprendido hace años, o porque una experiencia de la infancia sigue presente. Con paciencia y tiempo, aprenden a confiar en el agua, controlar la respiración y moverse con más soltura, paso a paso, con el nivel de reto adecuado.

Mi motivación se ha convertido en una misión.
...
Mi enfoque es cercano, personal y sin presiones. Avanzamos paso a paso, siempre a tu ritmo. Sin gritos, sin forzar, sin juicios, solo paciencia, claridad y confianza.

El humor es una herramienta, construida sobre una base de seguridad.
...
Nadar no se trata de rendimiento. Se trata de sentirse seguro, relajado y libre en el agua. Y sí, incluso los adultos pueden aprender a disfrutarlo.`,
    ...
    info: {
      ...
      subtitle: "Precios, ubicación y horarios, claramente.",
      trust_45: "45 minutos por clase",
      trust_safe: "Cercano, discreto, sin juicios",
      ...
      location_desc: "Zelanda, discreto y cómodo.",
      location_body:
        "Las clases se realizan en una instalación tranquila en Zelanda. Los detalles exactos se comparten tras la inscripción para cuidar la privacidad y mantener un buen ambiente.",
      location_cta: "Pregunta por la opción más cercana",
      scheduling_title: "Horarios",
      scheduling_desc: "Entre semana, opciones flexibles.",
      scheduling_body:
        "Normalmente hay clases entre semana, con opciones por la mañana o por la tarde. Envíanos tus horarios preferidos y confirmamos disponibilidad.",
      scheduling_cta: "Comprobar disponibilidad",
      price_tryout: "Clase de prueba (45 min, una vez)",
      price_private: "Clase 1:1 (45 min)",
    ...
    for_you: {
      ...
      subtitle:
        "Estas clases están diseñadas para adultos de todos los orígenes que quieren encontrar comodidad y seguridad en el agua. Comprueba si algo de esto te resulta familiar.",
      ...
      who_list: [
        ...
        "Cualquiera que quiera aprender en un entorno discreto y sin juicios.",
      ...
      reassurances: [
        {
          ...
          description:
            "Nuestras clases empiezan desde el principio. No asumimos nada y lo enseñamos todo.",
        },
        {
          title: "Está bien estar nervioso.",
          description:
            "Muchos adultos sienten lo mismo. Nuestro primer objetivo es ayudarte a sentirte seguro y cómodo.",
        },
        {
          title: "El idioma no es una barrera.",
          description:
            "Las clases son en inglés sencillo. El enfoque está en una instrucción clara y constante.",
        },
        {
          title: "No hay un plazo 'correcto'.",
          description:
            "Progresarás a tu propio ritmo. No hay presión para rendir.",
        },
      ],
      cta_title: "Tu viaje comienza con una simple conversación.",
      cta_subtitle:
        "Si tienes alguna pregunta, o simplemente quieres saber si esto es para ti, por favor, ponte en contacto. No hay ningún compromiso.",
